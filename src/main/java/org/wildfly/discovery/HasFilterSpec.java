...
public final class HasFilterSpec extends FilterSpec {
    ...
    public boolean equals(final FilterSpec other) {
        return other instanceof HasFilterSpec && equals((HasFilterSpec) other);
    }

    public boolean equals(final HasFilterSpec other) {
        return this == other || other != null && attribute.equals(other.attribute);
    }

    public int hashCode() {
        int hashCode = this.hashCode;
        if (hashCode == 0) {
            hashCode = getClass().hashCode() * 19 + attribute.hashCode();
